...
export default class SignUpScreen extends Component {
  ...
  render() {
    const images = {
      ...
      CREATE_BTN: {
        true: require('../assets/images/signup_create_btn_activated.png'),
        false: require('../assets/images/signup_create_btn_default.png')
      }
    }
              ...
              <View style={[{flex: 3}]}>
                <TouchableOpacity style={[styles.touchableOpacity, {flex: 1}]}
                  ...
                  <Image
                    ...
                    resizeMode="contain"
                    source={require('../assets/images/signup_back_btn.png')}
                  />
                </TouchableOpacity>
              </View>
